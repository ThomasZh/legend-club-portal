...
#        ./crntb-adm.sh uninstall
        echo "Stopping club.7x24hs.com service, begin killing ${PID}"
    ...
    if [ "$PID" != "" ] ; then
        echo "Starting club.7x24hs.com service..."
        nohup python index.py -log_file_prefix=./log/club.log &
        echo $! > pidfile    #record process id to file
        echo 'Startup club.7x24hs.com service success!'
